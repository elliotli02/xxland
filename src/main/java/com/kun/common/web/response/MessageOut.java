...
public class MessageOut<T> implements Out<T> {
	...
	// 登录成功/失败 提示信息
	public static final MessageOut<Object> LOGIN_OK_MESSAGE = new MessageOut<Object>(true, "登録成功しました。");
	public static final MessageOut<Object> LOGIN_FAIL_MESSAGE = new MessageOut<Object>(false, "入力したユーザー名とパスワードが一致しません。");
	// 登录成功/失败 提示信息
